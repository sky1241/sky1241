...
<!-- MILESTONES:START -->
```
2026-06-11  ─  where-is-typewise · fix(BUG-003): re-fetched threads wiped their scores — eve…
2026-06-07  ─  bug-bounty · Init: agrégateur bug bounty + scope guard audité + générateur de…
2026-05-28  ─  where-is-typewise · fix(pricing): treat ROI=0.0 as a valid value, not None
2026-05-26  ─  MUNINN- · ROUND 13.5 — senior dev pro grade: lint + community files + CodeQL…
